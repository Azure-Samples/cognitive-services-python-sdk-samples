...
def face_detection(subscription_key):
    ...
    for image_file_name in image_file_names:
        detected_faces = face_client.face.detect_with_url(url=image_url_prefix + image_file_name, return_face_attributes = [
...
def group_run(subscription_key):
    ...
    group_result = face_client.face.group(face_ids=face_ids)
